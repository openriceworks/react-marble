...
exports.HttpStatus = exports.HttpMethodType = void 0;
var HttpMethodType;
(function (HttpMethodType) {
    HttpMethodType[HttpMethodType["POST"] = 0] = "POST";
    HttpMethodType[HttpMethodType["PUT"] = 1] = "PUT";
    HttpMethodType[HttpMethodType["PATCH"] = 2] = "PATCH";
    HttpMethodType[HttpMethodType["GET"] = 3] = "GET";
    HttpMethodType[HttpMethodType["HEAD"] = 4] = "HEAD";
    HttpMethodType[HttpMethodType["DELETE"] = 5] = "DELETE";
    HttpMethodType[HttpMethodType["CONNECT"] = 6] = "CONNECT";
    HttpMethodType[HttpMethodType["OPTIONS"] = 7] = "OPTIONS";
    HttpMethodType[HttpMethodType["TRACE"] = 8] = "TRACE";
    HttpMethodType[HttpMethodType["*"] = 9] = "*";
...
(function (HttpStatus) {
    ...
    HttpStatus[HttpStatus["NONAUTHORITATIVE_INFORMATION"] = 203] = "NONAUTHORITATIVE_INFORMATION";
